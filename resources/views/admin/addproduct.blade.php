                ...
                <div class="content-wrapper">
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-description"> Isi form untuk menambahkan produk baru </p>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="exampleInputEmail3" name="harga" placeholder="Harga">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword4">Stok Produk</label>
                                <input type="number" class="form-control" id="exampleInputPassword4" name="stok" placeholder="Stok">
                            </div>
                            <div class="form-group">
